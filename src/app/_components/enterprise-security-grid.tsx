...
export function EnterpriseSecurityGrid() {
  return (
    <section className="py-12 sm:py-16 px-4 sm:px-6 bg-white border-t border-slate-200/80 relative overflow-hidden">
      {/* Ambient soft glow */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12 max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-[#0B132B] mb-4 tracking-tight leading-tight">
        ...
        {/* Multi-Channel Booking Capability Ribbon */}
        <div className="mt-14 border-t border-slate-200/60 pt-10 text-center relative z-10">
          <p className="text-xs font-bold text-[#00B7A8] uppercase tracking-widest mb-4">Frictionless Patient Access • Zero App Download Required</p>
          <h4 className="text-xl sm:text-2xl font-bold text-[#0B132B] mb-6">Patients Can Book Confirmed Slots From Any Device or Channel</h4>
          <div className="flex flex-wrap justify-center items-center gap-3 max-w-4xl mx-auto">
            <span className="px-4 py-2 rounded-2xl bg-emerald-50 border border-emerald-200 text-[#0B132B] text-xs sm:text-sm font-bold shadow-2xs">
              💬 1-Tap WhatsApp
            </span>
            <span className="px-4 py-2 rounded-2xl bg-blue-50 border border-blue-200 text-[#0B132B] text-xs sm:text-sm font-bold shadow-2xs">
              📍 Google Maps Profile
            </span>
            <span className="px-4 py-2 rounded-2xl bg-amber-50 border border-amber-200 text-[#0B132B] text-xs sm:text-sm font-bold shadow-2xs">
              📱 Front-Desk QR Standee
            </span>
            <span className="px-4 py-2 rounded-2xl bg-teal-50 border border-teal-200 text-[#0B132B] text-xs sm:text-sm font-bold shadow-2xs">
              🌐 Your Clinic Website
            </span>
            <span className="px-4 py-2 rounded-2xl bg-purple-50 border border-purple-200 text-[#0B132B] text-xs sm:text-sm font-bold shadow-2xs">
              🚶 Instant Reception Walk-in
            </span>
          </div>
        </div>
