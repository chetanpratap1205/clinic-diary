      ...
      <div className="w-full max-w-[1600px] mx-auto relative z-10 flex flex-col lg:flex-row items-stretch flex-grow h-full">
        ...
        <div className="w-full lg:w-[55%] relative z-10 flex justify-end h-[480px] sm:h-[600px] lg:h-full mt-8 lg:mt-0">
          ...
          <motion.div
            ...
            className="relative w-full h-full rounded-2xl lg:rounded-none lg:rounded-tl-[40%] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.12)] ring-1 ring-black/5"
          >
            <Image
            ...
            <div className="absolute inset-0 rounded-2xl lg:rounded-none lg:rounded-tl-[40%] shadow-[inset_0_0_80px_rgba(0,0,0,0.05)] pointer-events-none" />
          </motion.div>

          {/* Popups (Redesigned with Glassmorphism & Strategic Placement) */}
          
          {/* 1. WhatsApp Notification (Top Right - Wall Area) */}
          <motion.div
             initial={{ opacity: 0, y: -20 }}
            ...
            className="absolute right-[2%] sm:right-[4%] lg:right-[8%] top-[2%] sm:top-[6%] lg:top-[12%] bg-white/85 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.12)] rounded-xl p-3 w-[220px] sm:w-[240px] lg:w-[260px] z-30 scale-[0.85] sm:scale-95 lg:scale-100 origin-top-right"
          >
            <div className="flex items-start gap-3">
              <div className="bg-[#25D366] rounded-full p-1.5 flex-shrink-0 mt-0.5 shadow-sm">
                <MessageSquare className="w-4 h-4 text-white fill-white" />
              </div>
              <div className="w-full">
                <div className="flex justify-between items-center mb-1">
                  <div className="text-[11px] font-bold text-[#0B132B]">WhatsApp</div>
                  <div className="text-[9px] text-[#64748B] font-medium">9:30 AM</div>
                </div>
                <p className="text-[11px] text-[#334155] leading-snug pr-2 font-medium">
          ...
          {/* 2. Follow-up Reminder (Top Left - Window/Hallway Area) */}
          <motion.div
            ...
            className="absolute left-[2%] sm:left-[4%] lg:left-[2%] top-[18%] sm:top-[22%] lg:top-[28%] bg-white/85 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.12)] rounded-xl p-3 w-[180px] sm:w-[200px] lg:w-[210px] flex items-start gap-3 z-30 scale-[0.8] sm:scale-90 lg:scale-100 origin-top-left"
          >
             <div className="bg-blue-500/10 p-1.5 rounded-lg flex-shrink-0 border border-blue-500/20">
              ...
              <div>
                ...
                <div className="text-[10px] text-[#64748B] font-medium">Patient: Neha Sharma</div>
              </div>
          </motion.div>

          {/* 3. Google Review (Bottom Right - Near Patient/Desk Edge) */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            ...
            className="absolute right-[2%] sm:right-[4%] lg:right-[6%] bottom-[22%] sm:bottom-[28%] lg:bottom-[35%] bg-white/85 backdrop-blur-xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.12)] rounded-xl p-3 lg:p-3.5 w-[200px] sm:w-[220px] lg:w-[240px] flex items-start gap-2.5 lg:gap-3 z-30 scale-[0.8] sm:scale-90 lg:scale-100 origin-bottom-right"
          >
            <div className="bg-white rounded-full p-1 shadow-sm flex-shrink-0 mt-0.5">
              <svg viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg" className="lg:w-[20px] lg:h-[20px]">
            ...
            <div>
              <div className="flex justify-between items-center mb-0.5 lg:mb-1">
                 <div className="text-[10px] lg:text-[11px] font-bold text-[#0B132B]">New Google Review</div>
                 <div className="text-[8px] lg:text-[9px] text-[#64748B] font-medium">9:45 AM</div>
              </div>
              <div className="flex gap-[1px] mb-1 lg:mb-1.5">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-2.5 h-2.5 lg:w-3 lg:h-3 text-[#F59E0B] fill-[#F59E0B]" />
                ))}
              </div>
              <p className="text-[10px] lg:text-[11px] text-[#334155] leading-snug font-medium">
                Excellent experience and very well managed clinic!
              </p>
            </div>
          </motion.div>

          {/* 4. Today's Overview (Bottom Left - Empty Desk Area) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: [0, 3, 0] }}
            transition={{ 
            ...
            className="absolute left-[2%] sm:left-[4%] lg:left-[8%] bottom-[2%] sm:bottom-[4%] lg:bottom-[8%] bg-white/85 backdrop-blur-xl border border-white/60 shadow-[0_12px_40px_rgba(0,0,0,0.18)] rounded-2xl p-4 lg:p-5 w-[280px] sm:w-[320px] lg:w-[380px] z-30 scale-[0.85] sm:scale-90 lg:scale-100 origin-bottom-left"
          >
            <div className="flex justify-between items-center mb-3 lg:mb-4">
              <div className="text-[11px] lg:text-[12px] font-bold text-[#0B132B]">Today's Overview</div>
              <div className="text-[9px] lg:text-[10px] text-[#00B7A8] font-bold cursor-pointer hover:text-[#00998c] transition-colors">View Dashboard</div>
            </div>
            
            <div className="flex justify-between items-end mb-3 lg:mb-4 pr-2 lg:pr-4">
              <div>
                <div className="text-[9px] lg:text-[10px] text-[#64748B] font-semibold mb-0.5 lg:mb-1">Appointments</div>
                <div className="flex items-baseline gap-1.5 lg:gap-2">
                  <span className="text-[18px] lg:text-[22px] font-black text-[#0B132B] leading-none tracking-tight">28</span>
                  <span className="text-[9px] lg:text-[10px] text-[#10B981] font-bold bg-[#10B981]/10 px-1 rounded">+12%</span>
                </div>
              </div>
              <div>
                <div className="text-[9px] lg:text-[10px] text-[#64748B] font-semibold mb-0.5 lg:mb-1">New Patients</div>
                <div className="flex items-baseline gap-1.5 lg:gap-2">
                  <span className="text-[18px] lg:text-[22px] font-black text-[#0B132B] leading-none tracking-tight">07</span>
                  <span className="text-[9px] lg:text-[10px] text-[#10B981] font-bold bg-[#10B981]/10 px-1 rounded">+8%</span>
                </div>
              </div>
              <div>
                <div className="text-[9px] lg:text-[10px] text-[#64748B] font-semibold mb-0.5 lg:mb-1">Follow-ups</div>
                <div className="flex items-baseline gap-1.5 lg:gap-2">
                  <span className="text-[18px] lg:text-[22px] font-black text-[#0B132B] leading-none tracking-tight">15</span>
                  <span className="text-[9px] lg:text-[10px] text-[#10B981] font-bold bg-[#10B981]/10 px-1 rounded">+10%</span>
                </div>
              </div>
            </div>

            <div className="w-full h-6 lg:h-8 relative mt-1">
               <svg viewBox="0 0 340 30" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                 ...
                 <path d="M0 25 Q30 20, 60 22 T120 15 T180 20 T240 10 T280 25 T340 5" fill="none" stroke="#10B981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
