...
export default async function BookingPage({
  ...
  return (
      <div className="w-full flex flex-col-reverse lg:grid lg:grid-cols-12 gap-10 lg:gap-16">
        ...
        <div className="lg:col-span-5 flex flex-col space-y-8">
          ...
          {clinic.googleMapsUrl && (
            <div className="rounded-3xl shadow-sm overflow-hidden bg-white border border-slate-200">
              <iframe
