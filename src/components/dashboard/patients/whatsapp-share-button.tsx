...
export function WhatsAppShareButton({ patientName, trackingUrl }: WhatsAppShareButtonProps) {
  ...
  return (
    <Button
      ...
      aria-label="Send Tracking Link on WhatsApp"
      className="bg-[#25D366] hover:bg-[#128C7E] text-white shadow-sm rounded-xl h-9 w-9 p-0 flex items-center justify-center flex-shrink-0"
    >
