...
/**
 * Sovereign Indian Data Center Localization Badge
 */
function DataResidencyBadge() {
  return (
    <div className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-slate-50 to-emerald-50 border border-slate-200 flex items-center justify-center p-2 shadow-xs group-hover:scale-105 transition-transform">
      <svg viewBox="0 0 48 48" fill="none" className="w-full h-full">
        <rect x="10" y="8" width="28" height="32" rx="4" fill="#F1F5F9" stroke="#0B132B" strokeWidth="1.8" />
        {/* Server Rack Slots */}
        <rect x="14" y="13" width="20" height="5" rx="1.5" fill="#0B132B" />
        <circle cx="17" cy="15.5" r="1" fill="#00B7A8" />
        <circle cx="20" cy="15.5" r="1" fill="#3B82F6" />
        
        <rect x="14" y="21" width="20" height="5" rx="1.5" fill="#0B132B" />
        <circle cx="17" cy="23.5" r="1" fill="#00B7A8" />
        <circle cx="20" cy="23.5" r="1" fill="#3B82F6" />

        <rect x="14" y="29" width="20" height="5" rx="1.5" fill="#0B132B" />
        <circle cx="17" cy="31.5" r="1" fill="#00B7A8" />
        <circle cx="20" cy="31.5" r="1" fill="#3B82F6" />

        {/* Indian Flag Strip on Bottom */}
        <path d="M14 36H34" stroke="#FF9933" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M14 38H34" stroke="#00B7A8" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    </div>
  );
}
